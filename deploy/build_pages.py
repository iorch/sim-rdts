...
<div class="wrap">
  ...
  <p class="foot">
    <b>Hallazgos.</b> El fork es de consenso (no solo de relay). El softfork "gana" (Core
    reorganiza a la cadena limpia) con una <b>leve supermayoría ~55-57%</b> de hashpower, no en
    50%. El <b>número de nodos no importa</b> — solo el hashpower. Y Core empieza a perder
    <b>≥1 bloque/día</b> por reorg desde ~30% de hashpower Knots, creando incentivo temprano a
    señalar RDTS.<br><br>
