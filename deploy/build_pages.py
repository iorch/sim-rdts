...
.cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(238px,1fr));gap:16px;margin:34px 0 24px;}
...
<div class="wrap">
  ...
  <div class="cards">
    ...
    <a class="card win" href="sim2.html">
      ...
      <h2>Nodos frente a hashpower</h2>
      <p>Core en pocos mineros grandes frente a Knots disperso. ¿Importa el número de nodos?
      ¿Cada cuánto pierde bloques Core?</p>
      <div class="go">Ver dashboard →</div>
    </a>
    <a class="card fee" href="sim3.html">
      <div class="tag">Experimento 3 · modelo económico</div>
  ...
  <p class="foot">
    <b>Hallazgos.</b> El fork es de consenso (no solo de retransmisión) y <b>lo decide el hashpower,
    no el número de nodos</b> (Knots con 16 a 30 nodos pierde igual por debajo del umbral). El
    softfork "gana" una guerra de reorganizaciones con una leve supermayoría (~55-57%), pero el
    <b>incentivo real llega mucho antes</b>: cuando la probabilidad de que un bloque con datos quede
    huérfano deja de ser despreciable, incluir datos deja de ser rentable. La respuesta racional del
    minero Core no es "señalar RDTS" sino, más simple, <b>dejar de incluir datos</b> — y cuando lo
    hace, la cadena converge sola (Experimento 3).<br><br>
