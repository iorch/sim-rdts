...
<div class="wrap">
  ...
  <p class="foot">
    <b>Hallazgos.</b> Lo decisivo es el <b>cruce de incentivos, no el de victoria</b>: Core empieza
    a perder <b>≥1 bloque/día</b> por reorg desde apenas <b>~30% de hashpower Knots</b> — mucho
    antes del <b>~55-57%</b> en que el softfork realmente gana. Ese ≥1/día le da a un minero Core
    incentivo a <b>señalar RDTS</b> para dejar de perder bloques, empujando el share hacia arriba
    (efecto cascada). Además: el fork es de consenso (no solo de relay), y <b>el número de nodos no
    importa</b> — solo el hashpower (Knots con 16-30 nodos pierde igual por debajo del umbral).<br><br>
