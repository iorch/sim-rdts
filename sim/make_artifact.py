...
<div class="wrap">
  ...
  <p class="foot">
    ...
    <b>Incentivo económico.</b> El costo real para un minero Core es cuánto deberían pagar los datos
    para compensar el riesgo de que su bloque quede huérfano (premio de equilibrio). Ese análisis,
    con la orfandad <b>medida por hash</b>, está en el <b>modelo económico</b>: el premio cruza el
    100% del premio de bloque cerca del <b>~54% de hashpower Knots</b>. <i>(Corrección: una versión
    anterior citaba aquí un umbral de "~30%" derivado de un conteo de reorganizaciones que resultó
    inflado por carreras de propagación entre mineros Core; se reemplazó por la medición correcta.)</i><br><br>
